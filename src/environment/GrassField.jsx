...
const bladeUniforms = {
  ...
  uGrassBottom: { value: new THREE.Color(0x6fa85f) },
  uGrassTop: { value: new THREE.Color(0x9ccc76) },
  uBrightness: { value: 0.95 },
  uGradStart: { value: 0.15 },
  uGradEnd: { value: 1.0 },
  uGradPower: { value: 1.0 },
  uPatchLush: { value: new THREE.Color(0x6fa85f) },
  uPatchDry: { value: new THREE.Color(0xb1a86b) },
  uPatchStrength: { value: 0.12 },
  uPatchBias: { value: 1.5 },
  uShadowSamples: { value: 2 },
  uShadowStrength: { value: 0.28 },
  uSunDir: { value: new THREE.Vector3(0, 1, 0) },
  uSunColor: { value: new THREE.Color(1, 1, 1) },
  uTransColor: { value: new THREE.Color(0xb6d58b) },
  uTransStrength: { value: 0.65 },
