...
const PAGES = [
  {
    ...
    sections: [
      ...
      ['Placement', [
        ...
        <>Drag with Straight Track or Road to place a run; invalid spots are skipped</>,
        <>Each drag placement undoes and redoes as one action</>,
      ]],
    ],
  ...
  },
  {
    ...
    sections: [
      ['Camera and pause', [
        ...
        <>With Hand selected, LMB drag orbits and RMB drag pans</>,
        <>With other tools, RMB drag looks around in place like the arrow keys</>,
