...
function getStraightAssets() {
  ...
  straightAssets = {
    ...
    gravelMat: makeStyleMaterial('ballast', { repeat: [0.33, 0.33] }),
    sleeperGeo: new THREE.BoxGeometry(STRAIGHT_TRACK_WIDTH * 0.9, RAIL_HEIGHT * 0.6, RAIL_HEIGHT * 1.5),
    sleeperMat: makeStyleMaterial('planks', { repeat: [1, 1] }),
...
function getBridgeAssets() {
  ...
  bridgeAssets = {
    pillarMat: makeStyleMaterial('beam', { repeat: [1, 0.5] }),
    deckMat: makeStyleMaterial('wood_deck', { repeat: [1, 0.5] }),
    braceMat: makeStyleMaterial('beam', { repeat: [1, 1] }),
    capMat: makeStyleMaterial('beam', { repeat: [1, 1] }),
